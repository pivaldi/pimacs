...
(defun pim-which-key-get-bindings-recursively-org (prefix level &optional subkeys)
...
LEVEL represent the deep of the heading."
  ...
  ) ;; (insert (pim-which-key-get-bindings-recursively-org "M-g" 1))
...
PREFIX should be a string suitable for `kbd'."
  ...
  (with-temp-file file-name
    ...
    (save-excursion
      ...
      (insert (pim-which-key-get-bindings-recursively-org prefix 1))
      (toc-org-insert-toc))))
